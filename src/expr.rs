...
pub enum Expr {
    Constant { value: i64 },
    Add { lhs: Rc<Expr>, rhs: Rc<Expr> },
    Subtract { lhs: Rc<Expr>, rhs: Rc<Expr> },
    Multiply { lhs: Rc<Expr>, rhs: Rc<Expr> },
    Divide { lhs: Rc<Expr>, rhs: Rc<Expr> },
    Negate { expr: Rc<Expr> },
    Equal { lhs: Rc<Expr>, rhs: Rc<Expr> },
    NotEqual { lhs: Rc<Expr>, rhs: Rc<Expr> },
    LessThan { lhs: Rc<Expr>, rhs: Rc<Expr> },
    LessThanOrEqual { lhs: Rc<Expr>, rhs: Rc<Expr> },
    GreaterThan { lhs: Rc<Expr>, rhs: Rc<Expr> },
    GreaterThanOrEqual { lhs: Rc<Expr>, rhs: Rc<Expr> },
}
